...
if($act == "del")
{
	...
	//print "<script>self.location='a-job.php';</script>";
}
?>
<!DOCTYPE html>
<html>
	...
	<div class="w3-container w3-content" style="max-width:1400px;">    
	  ...
	  <div class="w3-row w3-white w3-card w3-padding">
		...
		<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
			...
			<?PHP
			$bil = 0;
			$SQL_list = "SELECT * FROM `job`,`company` WHERE job.id_company = company.id_company ";
			...
			<tr>
				...
				<td>
				<a href="a-job-edit.php?id_job=<?PHP echo $id_job;?>" class=""><i class="fa fa-fw fa-edit fa-lg"></i></a>
		...
		<form action="" method="post" >
			...
			<hr>
				...
				<div class="w3-section" >
					...
					{
					?>
						<option value="<?PHP echo $dat["id_company"];?>" ><?PHP echo $dat["company_name"];?></option>
					<?PHP } ?>
					</select>
				</div>
