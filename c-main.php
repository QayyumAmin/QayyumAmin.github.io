...
$tot_apply 		= numRows($con, "SELECT * FROM `apply` WHERE `id_company` = $id_company");
...
<div class="w3-container w3-padding-16" id="contact">
    <div class="w3-content w3-container " style="max-width:700px">
		<div class="w3-padding">
		<div class="w3-xxxlarge"><b>WELCOME</b></div>
		<div class="w3-large"><b>Company Page</b></div>
