...
if($act == "del")
{
	...
	//print "<script>self.location='c-apply.php';</script>";
}
?>
<!DOCTYPE html>
<html>
...
<!--- Toast Notification -->
<?PHP 
if($success) { Notify("success", $success, "c-apply.php?page=apply"); }
?>	
	...
	<div class="w3-container w3-content" style="max-width:1400px;">    
	  ...
	  <div class="w3-row w3-white w3-card w3-padding">
		...
		<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
			...
			<?PHP
			$bil = 0;
			$SQL_list = "SELECT * FROM `apply`,`job`,`company`,`user` WHERE apply.id_job=job.id_job AND job.id_company = company.id_company AND apply.id_user = user.id_user AND apply.id_company = $id_company";
			...
			<tr>
				<td><?PHP echo $bil ;?></td>			
				<td><b><?PHP echo $data["job_title"] ;?></b></td>
				<td>
				<?PHP echo $data["name"] ;?>
