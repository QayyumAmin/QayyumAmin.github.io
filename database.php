<?PHP
	...
	function verifyCompany($con)
	{
		if ($_SESSION['username'] && $_SESSION['password'] ) 
		{
		  $result=mysqli_query($con,"SELECT  `username`, `password` FROM `company` WHERE `username`='$_SESSION[username]' AND `password`='$_SESSION[password]' " ) ;
